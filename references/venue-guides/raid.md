...
> Migrated from the legacy `ccf-conference-skills/raid/SKILL.md` runtime skill during v0.4.0. This file is now reference material for `ccf-paper-writer-humanizer` and `ccf-submission-checker`, not a standalone skill.
