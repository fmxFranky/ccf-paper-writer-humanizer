...
- `ccf-paper-writer-humanizer-humanizer` owns manuscript edits, section restructuring, compression, and prose polish.
...
5. Apply `references/prose-quality-guardrails.md` and the `ccf-paper-writer-humanizer-humanizer` policy.
